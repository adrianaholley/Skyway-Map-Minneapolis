package com.example.skywaymappgoogle
...
fun drawArea0500(): PolylineOptions {
    return PolylineOptions()
        .color(Color.GREEN) //MEGABUS STOP
...
fun drawArea0502(): PolylineOptions {
    return PolylineOptions()
        .color(Color.GREEN) //advocates for human rights
...
fun drawArea0504(): PolylineOptions {
    return PolylineOptions()
        .color(Color.GREEN) //US DISTRICT COURT
...
fun drawArea0602(): PolylineOptions {
    return PolylineOptions()
        .color(Color.YELLOW) //fifth street towers
...
fun drawArea0713(): PolylineOptions {
    return PolylineOptions()
        .color(Color.RED) //PEOPLE'S PLAZA
...
fun drawArea0716(): PolylineOptions {
    return PolylineOptions()
        .color(Color.RED) //GOV CENTER RAMP
...
fun drawArea0807(): PolylineOptions {
    return PolylineOptions()
        .color(Color.BLACK) //Grand Hotel Minneapolis
...
fun drawArea0902(): PolylineOptions {
    return PolylineOptions()
        .color(Color.CYAN) //Raddisson blu
...
fun drawArea0905(): PolylineOptions {
    return PolylineOptions()
        .color(Color.CYAN) //Ameriprise HQ
...
fun drawArea0910(): PolylineOptions {
    return PolylineOptions()
        .color(Color.CYAN) //ameriprise financial headquarters
...
fun drawArea0914(): PolylineOptions {
    return PolylineOptions()
        .color(Color.CYAN) //AMERIPRISE FINANCIAL
...
fun drawArea1100(): PolylineOptions {
    return PolylineOptions()
        .color(Color.BLUE) //orpheum theatre
...
fun drawArea1106(): PolylineOptions {
    return PolylineOptions()
        .color(Color.BLUE) //GREYHOUND BUS STATION
...
fun drawArea1200(): PolylineOptions {
    return PolylineOptions()
        .color(Color.GREEN) //Univ St Thomas
...
fun drawArea1204(): PolylineOptions {
    return PolylineOptions()
        .color(Color.GREEN) //Hilton Minneapolis
...
fun drawArea1300(): PolylineOptions {
    return PolylineOptions()
        .color(Color.YELLOW) //st thomas Law
...
fun drawArea1301(): PolylineOptions {
    return PolylineOptions()
        .color(Color.YELLOW) //bolero flats
...
fun drawArea1304(): PolylineOptions {
    return PolylineOptions()
        .color(Color.YELLOW) //ST THOM LAW
        .add(LatLng(44.9740157, -93.2783849))
...
fun drawArea1402(): PolylineOptions {
    return PolylineOptions()
        .color(Color.RED) //Marquette Place
...
fun drawArea1404(): PolylineOptions {
    return PolylineOptions()
        .color(Color.RED) //CONVENTION CENTER
        .add(LatLng(44.97251, -93.272583))
